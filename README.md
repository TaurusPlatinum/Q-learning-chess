...
### **Path Visualization**
**Bishop Optimal Path:**
![Bishop Path](docs/bishop/1.png) (docs/bishop/2.png) (docs/bishop/3.png) (docs/bishop/4.png) (docs/bishop/5.png)

**Knight Optimal Path:**
![Knight Path](docs/knight/1.png)(docs/knight/2.png)(docs/knight/3.png)(docs/knight/4.png)
